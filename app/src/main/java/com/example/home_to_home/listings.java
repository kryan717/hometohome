...
//                }
                ...
                listView.setOnItemClickListener((adapter, v1, position, arg3) -> {
                    Map<String, Object> currentMap = test_list.get(position);
                    Intent intent = new Intent(listings.this,details.class);
                    intent.putExtra("name", (String) currentMap.get("name"));
                    intent.putExtra("desc", (String) currentMap.get("description"));
